...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "any_selection", "symbols": ["select_statement"], "postprocess": unwrap},
    {"name": "any_selection", "symbols": ["select_values"], "postprocess": unwrap},
    {"name": "any_selection", "symbols": ["with_statement"], "postprocess": unwrap},
    {"name": "any_selection", "symbols": ["with_recursive_statement"], "postprocess": unwrap},
    {"name": "any_selection", "symbols": ["union_statement"], "postprocess": unwrap},
    {"name": "selection", "symbols": ["lparen", "selection", "rparen"], "postprocess": get(1)},
    {"name": "selection", "symbols": ["any_selection"], "postprocess": get(0)},
